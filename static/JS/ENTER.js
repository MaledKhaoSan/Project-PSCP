...
ScrollTrigger.matchMedia({
    ...
    var tl = gsap.timeline();
        tl.to(".element_background0", 2,{force3D: true, ease: Power1.easeInOut, width:"116%", top: "50%", left: "50%"},">+0.5")
        tl.to(".element_background2", 3,{force3D: true, ease: Power1.easeInOut, width:"160%", top: "-100%", left: "-40%", rotation:"30"},"<")
        tl.to(".element_background1", 3,{force3D: true, ease: Power1.easeInOut, width:"330%", top: "-230%", left: "-120%", rotation:"0"},"<")
        tl.to(".element1", 2.0,{force3D: true, ease: Power1.easeInOut, width:"22.5%", top: "14%", left: "8%", rotation:"10"},"<+0.3")
        tl.to(".element2", 2.5,{force3D: true, ease: Power1.easeInOut, width:"33%", top: "87%", left: "65%", rotation:"16"},"<")
        tl.to(".element3", 2.3,{force3D: true, ease: Power1.easeInOut, width:"31%", top: "78%", left: "95%", rotation:"-18"},"<")
        tl.to(".element4", 2.2,{force3D: true, ease: Power1.easeInOut, width:"26.7%", top: "83%", left: "5%", rotation:"-3"},"<")
        tl.to(".element6", 2.0,{force3D: true, ease: Power1.easeInOut, width:"35%", top: "104%", left: "36%", rotation:"11"},"<")
        tl.to(".element7", 2.2,{force3D: true, ease: Power1.easeInOut, width:"25%", top: "-32%", left: "32%", rotation:"24"},"<")
        tl.to(".element8", 2.3,{force3D: true, ease: Power1.easeInOut, width:"20%", top: "-10%", left: "76%", rotation:"0"},"<")
        tl.from('.enter_heading', 2, {scale: 0,  force3D: true, ease: Power1.easeInOut, opacity: 0, ease: Power2.easeOut },"<");
        tl.to(".element_background3", 0.9, {force3D: true, ease: Power1.easeInOut, opacity: 0.67},"<+1.3");
        tl.to(".element_background4", 1.2, {force3D: true, ease: Power1.easeInOut, opacity: 0.6},"<");
    }
})
