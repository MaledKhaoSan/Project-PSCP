...
def sendCustomEmail():
    ...
    <body style="text-align: center; margin: 0; padding-top: 10px; padding-bottom: 10px; padding-left: 0; padding-right: 0; -webkit-text-size-adjust: 100%;background-color: #f2f4f6; color: #000000" align="center">
      ...
      <div style="text-align: center;">
        ...
        <!-- Hero image -->
        <img style="width: 600px; max-width: 600px; height: 350px; max-height: 350px; text-align: center;" alt="Hero image" src="https://raw.githubusercontent.com/MaledKhaoSan/mynewicon/main/assets/icons/gulp.png" align="center" width="600" height="350">
        <!-- Hero image -->
