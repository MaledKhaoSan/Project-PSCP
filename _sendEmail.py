      ...
      <tbody>
        <tr>
          <td style="width: 596px; vertical-align: top; padding-left: 0; padding-right: 0; padding-top: 15px; padding-bottom: 15px;" width="596">
            ...
            <img style="width: 120px; max-width: 180px; height: auto; text-align: center; color: #ffffff;" alt="Logo" src="https://raw.githubusercontent.com/MaledKhaoSan/Project-PSCP/main/static/IMG/EMAIL/email_""" + email_flowers +"""_icon.png" align="center" width="180" height="85">
        ...
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
              ...
              <h1 style="font-size: 20px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;">""" + email_flowers + """ from """+ username_arrias +"""</h1>
